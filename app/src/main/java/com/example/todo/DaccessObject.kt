...
class DaccessObject(val context: Context, val factory: SQLiteDatabase.CursorFactory?) :
    ...
    fun getAll() : List<Todo> {
        ...
        do {
            ...
            val date = Date(cursor.getLong(cursor.getColumnIndexOrThrow("date")))
            val creationDate = Date(cursor.getLong(cursor.getColumnIndexOrThrow("creationDate")))
